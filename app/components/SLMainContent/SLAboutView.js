			...
			<div className='sl-about-view'>
				<div className='sl-about-view--dialogue'>				
					<div className="sl-about-view--dialogue_reverse-colors">
						<h2>ABOUT ME</h2>
						<p>
							My name is Sean and I am Software Engineer and Web Developer. 
					...
					<div className='sl-about-view--dialogue_normal-colors'>
						...
						<p>
							...
							It not only makes you better at understanding the problems you need to accomplish, but makes it easier for others to support and maintain your code in the future.
						</p>
						<h3>MENTORSHIP</h3>
						<p>
						...
						<p>
							...
							Every line of code I write, every scrum task, every design I implement, and every redline I review, I constantly reminding myself:
						</p>
						<b>
